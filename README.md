...
```shell
1. mkdir windk && cd windk
2. curl -sSL "https://github.com/arakilian0/windk/archive/refs/heads/main.zip" -o repo.zip
3. tar -xf repo.zip --strip-components=1 && del repo.zip
4. setx PATH "%PATH%;%CD%\exe"
```
